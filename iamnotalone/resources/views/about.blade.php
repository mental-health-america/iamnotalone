    ...
    <div class="w-full w-max-700 m-auto p-h-20 p-t-10 p-b-10" style="padding: 15px 30px;">
        ...
        <div class="w-full w-max-700 m-auto p-h-20 p-t-10 p-b-10 my-10 bg-gray-100" style="padding: 15px;">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="mb-5 text-center"><a href="https://iamnotalone.mhanational.org/events"><img alt="empty" class="w-max-250 img-responsive mb-5" src="{{asset('images/about-attend.png')}}"/></a>
                ...
                <div class="mb-5 text-center"><a href="https://iamnotalone.mhanational.org/events/new"><img alt="empty" class="w-max-250 img-responsive mb-5" src="{{asset('images/about-create.png')}}"/>
                    </a>
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                ...
                <div class="mb-5 text-center"><a href="https://iamnotalone.mhanational.org/forum"><img alt="empty" class="w-max-250 img-responsive mb-5" src="{{asset('images/about-engage.png')}}"/>
                    </a>
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
