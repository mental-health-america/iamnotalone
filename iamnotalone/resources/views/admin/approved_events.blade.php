        ...
        <tbody class="text-gray-600 text-sm font-medium" id="tbody">
            ...
            <tr class="bg-white my-3 text-center">
                ...
                <td class="text-center py-4 my-2">
                    ...
                    Online
                    @elseif($event->inperson && !$event->online)
                    inperson
                    @else
                    Hybrid
                    @endif
                ...
                <td class="text-center py-4 my-2">
                    <div class="relative">
                        <a href="#" class="relative z-2 block rounded-md bg-white p-2 focus:outline-none"
                            onclick="showHideMenu('op{{$event->id}}')">
                        ...
                        <div class="absolute right-0 mt-2 ml-10 w-32 bg-white rounded-md shadow-xl z-20 hidden"
                            id="op{{$event->id}}">
                            <a href="{{route('admin.event.details', ['id'=>$event->id])}}"
                            ...
                            <a href="#eventModal" data-title=""
                                data-url="{{route('admin.event.update', ['id'=>$event->id])}}"
                                data-event={{base64_encode(json_encode($event))}} rel="modal:open"
                            ...
                            @if (!$event->approved)
                            <a href="{{route('admin.event.approve', ['id'=>$event->id])}}"
                                class="block px-2 py-3 rounded text-sm capitalize text-gray-700 bg-gradient-to-r hover:from-purple-400 hover:via-pink-500 hover:to-red-500 hover: hover:text-white">
                                Approve Activity
                            </a>
                            <a href="#" id="openModal"
                                class="block px-2 py-3 rounded text-sm capitalize text-gray-700 bg-gradient-to-r hover:from-purple-400 hover:via-pink-500 hover:to-red-500 hover: hover:text-white"
                                data-fname="{{$event->organizer->first_name}}"
                                data-lname="{{$event->organizer->last_name}}" data-uid="{{$event->user_id}}"
                                data-eid="{{$event->id}}" onclick="openModal(this)">
                                Delete Activity
                            </a>
                            @endif
                        </div>
    ...
    <form class="text-center" method="POST" id="editEventForm" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 md:gap-4">
                    <div class="py-2 text-left">
                        <input type="text"
                            class="bg-white text-sm border-2 border-gray-100 focus:outline-none block w-full p-4 rounded-lg focus:border-gray-700 "
                            placeholder="State" id="state" name="state" value="{{old('state', '')}}" />
        ...
        <div class="hybrid">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-4">
                <div class="py-2 text-left">
                    <input type="text"
                        class="bg-white text-sm border-2 border-gray-100 focus:outline-none block w-full p-4 rounded-lg focus:border-gray-700 "
                        placeholder="State" id="hybrid_state" name="hybrid_state" value="{{old('state', '')}}" />

                </div>
                <div class="py-2 text-left">
                    <input type="text"
                        class="bg-white border-2 text-sm border-gray-100 focus:outline-none block w-full p-4 rounded-lg focus:border-gray-700 "
                        placeholder="City" id="hybrid_city" name="hybrid_city" value="{{old('city', '')}}" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-8">
            <div class="py-2 text-left">
                ...
                <input type="date"
                    class="border-2 text-sm border-gray-100 focus:outline-none block w-full p-4 rounded-lg focus:border-gray-700 "
                    placeholder="State Date" name="start_date" id="start_date" value="{{$event->start_date}}" />
            </div>
            ...
            <div class="py-2 text-left">
                ...
                <input type="time"
                    ...
                    placeholder="Start Time" name="start_time" id="start_time" value="{{$event->start_time}}" />
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-8">
            <div class="py-2 text-left">
                ...
                <input type="date"
                    class="border-2 text-sm border-gray-100 focus:outline-none block w-full p-4 rounded-lg focus:border-gray-700 "
                    placeholder="End date" name="end_date" id="end_date" value="{{$event->end_date}}" />
            </div>
            ...
            <div class="py-2 text-left">
                ...
                <input type="time"
                    class="border text-sm border-gray-100 focus:outline-none block w-full p-4 rounded-lg focus:border-gray-700"
                    placeholder="End Time" name="end_time" id="end_time" value="{{$event->end_time}}" />
            </div>
        </div>
