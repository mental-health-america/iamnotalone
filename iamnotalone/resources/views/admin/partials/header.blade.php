<header class="w-full mx-auto py-6 mb-8">
    <span x-data="{ dropdownOpen: false }" class="float-right mt-2">
        ...
        <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
            ...
            <a href="{{route('signout')}}" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
                Sign Out
            </a>
        </div>
    </span>

    <img src="{{asset('images/vectors/user.jpg')}}" class="w-12 float-right rounded-2xl" alt="">
