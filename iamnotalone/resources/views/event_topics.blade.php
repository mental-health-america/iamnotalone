...
@section('content')
    <div class="flex flex-col md:flex-row text-gray-600">
        ...
        <div class="w-full md:w-3/6 flex flex-col px-4 md:px-12">
            ...
            <div class="my-8">
                <h3 class="text-2xl">Topics Related to <a href="{{route('event.details', ['id'=>$event->id])}}" class="text-indigo-800 underline">{{$event->name}}</a> Event</h3>
            </div>
                        ...
                        <div class="flex flex-col sm:flex-row text-xs font-semibold mt-4">
                            ...
                            <p class="sm:w-1/3 mt-2">
                                ...
                                <span class="text-right text-indigo-800">
                                    <a href="{{route('forum.post', ['id'=>$post->id])}}" class="">view</a>
                                </span>
                            </p>
                        </div>
                    </div>
