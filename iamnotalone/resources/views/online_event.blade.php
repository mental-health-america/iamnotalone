        ...
        <div class="flex flex-1 items-center justify-center">
            <div class="px-4 sm-px-0 lg:w-3/5 sm:w-4/5 w-full sm:m-auto text-gray-600">
                ...
                <div class="flex flex-col sm:flex-row mb-6 justify-items-center">
                    ...
                    <a href="{{route('event.online')}}" class="capitalize text-center border-2 sm:mx-4 border-indigo-400 focus:outline-none bg-primary text-white font-medium tracking-wider block w-3/4 sm:w-1/3 m-auto mb-4 py-3 rounded-lg focus:border-gray-700 hover:bg-purple-700">
                        Online
                    </a>
