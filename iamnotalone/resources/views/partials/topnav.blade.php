        ...
        @auth
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                ...
                <div class="px-2 py-2 bg-white text-black rounded-md shadow dark-mode:bg-gray-800">
                    <a class="block text-center px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg  md:mt-0 hover:text-white focus:text-gray-900 hover:bg-indigo-500 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{route('event.user')}}">My Events</a>
                    <a class="block text-center px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg  hover:text-white focus:text-gray-900 hover:bg-indigo-500 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{route('signout')}}">Signout</a>
                </div>
                </div>
            </div>   
        @endauth
