    ...
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden relative mx-8  md:block">
                ...
                <img src="{{asset('images/slider/slide1.png')}}" class="absolute h-full max-w-1/2 hidden lg:block hidden right-0 top-0 z-1"/>
            </div>
        ...
        <div class="swiper-slide">
            <div class="bg-white slider-z dark:bg-gray-800 overflow-hidden relative mx-8">
                ...
                <img src="{{asset('images/slider/slide2.png')}}" class="absolute h-full max-w-1/2 hidden lg:block right-0 top-0 mr-8 z-20"/>
            </div>
        </div>
        <div class="swiper-slide">
            <div class="bg-white slider-z dark:bg-gray-800 overflow-hidden relative mx-8 sm:mx-1">
                ...
                <img src="{{asset('images/slider/slide3.png')}}" class="absolute h-full max-w-1/2 hidden lg:block right-0 top-0 mr-8 z-20"/>
            </div>
        </div>
    </div>
