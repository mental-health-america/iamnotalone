        ...
        <div class="w-full md:w-3/6 flex flex-col px-4 md:px-12">
            ...
            <div class="w-full mt-8 sm:p-12 p-6 overflow-hidden rounded-lg border-2 shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
                ...
                <div class="">
                    ...
                    <form class="text-center" method="POST" action="<?php echo e(route('peers.forum.comment.new')); ?>">
                        <?php echo csrf_field(); ?>                        
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/peers/post.blade.php ENDPATH**/ ?>