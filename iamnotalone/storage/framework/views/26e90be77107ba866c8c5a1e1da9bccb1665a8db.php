    ...
    <section class="flex flex-col mb-10">
        <div class="flex flex-1 items-center justify-center">
            <div class="px-4 sm-px-0 lg:w-3/5 sm:w-4/5 w-full sm:m-auto w-full text-gray-600">
                ...
                <form class="" method="POST" action="<?php echo e(route('event.date.set')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/event_date.blade.php ENDPATH**/ ?>