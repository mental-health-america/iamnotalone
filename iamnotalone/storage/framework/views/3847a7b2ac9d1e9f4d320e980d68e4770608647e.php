    ...
    <div class="w-full w-max-700 m-auto p-h-20 p-t-10 p-b-10" style="padding: 15px 30px;">
        <div class="w-full w-max-700 m-auto p-h-20 p-t-10 p-b-10" style="padding: 15px 30px;">
            ...
            <p>We are facing a loneliness epidemic that is impacting mental health and well-being. Research shows that 3
                in 5 Americans feel lonely.<sup><a href="#_ftn1" name="_ftnref1" title="">[1]</a></sup> Additionally, <a
                    href="https://mhanational.org/mental-health-and-covid-19-what-mha-screening-data-tells-us-about-impact-pandemic#Loneliness" class="text-blue-700">Mental
            ...
            <ul class="list-disc">
                <li>Young people are more likely to be at risk for experiencing loneliness. <sup><a href="#_ftn3" name="_ftnref3" title="">[1]</a></sup>
                </li>
        ...
        <div class="w-full w-max-700 m-auto p-h-20 p-t-10 p-b-10 my-10 bg-gray-100" style="padding: 15px;">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="mb-5 text-center"><a href="https://iamnotalone.mhanational.org/events"><img alt="empty" class="w-max-250 img-responsive mb-5" src="<?php echo e(asset('images/about-attend.png')); ?>"/></a>
                ...
                <div class="mb-5 text-center"><a href="https://iamnotalone.mhanational.org/events/new"><img alt="empty" class="w-max-250 img-responsive mb-5" src="<?php echo e(asset('images/about-create.png')); ?>"/>
                    </a>
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                ...
                <div class="mb-5 text-center"><a href="https://iamnotalone.mhanational.org/forum"><img alt="empty" class="w-max-250 img-responsive mb-5" src="<?php echo e(asset('images/about-engage.png')); ?>"/>
                    </a>
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        ...
        <div class="w-full w-max-700 m-auto p-h-20 p-t-10 p-b-10" style="padding: 15px;">
            ...
            <div id="ftn1">
                <h6><sup><a href="#_ftnref1" name="_ftn1" title="">[1]</a></sup><a  class="text-blue-700"
            ...
            <div id="ftn2">
                <h6><sup><a href="#_ftnref2" name="_ftn2" title="">[2]</a></sup> <a  class="text-blue-700"
            ...
            <div id="ftn3">
                <h6><sup><a href="#_ftnref3" name="_ftn3" title="">[3]</a></sup> <a  class="text-blue-700"
            ...
            <div id="ftn4">
                <h6><sup><a href="#_ftnref4" name="_ftn4" title="">[4]</a></sup> <a  class="text-blue-700"
                        href="https://doi.org/10.17226/25663">https://doi.org/10.17226/25663</a></h6>
            </div>

            <div id="ftn5">
                <h6><sup><a href="#_ftnref5" name="_ftn5" title="">[5]</a></sup> <a  class="text-blue-700"
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/about.blade.php ENDPATH**/ ?>