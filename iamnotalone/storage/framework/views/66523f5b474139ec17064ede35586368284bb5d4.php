        ...
        <div class="flex flex-1 items-center justify-center">
            <div class="px-4 sm-px-0 lg:w-3/5 sm:w-4/5 w-full sm:m-auto text-gray-600">
                ...
                <div class="flex flex-col sm:flex-row mb-6 justify-items-center">
                    <a href="<?php echo e(route('event.inperson')); ?>" class="capitalize text-center border-2 border-indigo-400 focus:outline-none bg-primary text-white font-medium tracking-wider w-3/4 sm:w-1/3 m-auto mb-4 block py-3 rounded-lg focus:border-gray-700 hover:bg-purple-600">
                        In-Person
                    </a>
                ...
                <form class="" method="POST" action="<?php echo e(route('event.update.inperson')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/inperson_event.blade.php ENDPATH**/ ?>