...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col md:flex-row text-gray-600">
        ...
        <div class="w-full md:w-3/6 flex flex-col px-4 md:px-12">
            ...
            <div class="my-8">
                <h3 class="text-2xl">Topics Related to <a href="<?php echo e(route('event.details', ['id'=>$event->id])); ?>" class="text-indigo-800 underline"><?php echo e($event->name); ?></a> Event</h3>
            </div>
            ...
            <?php if(count($posts)): ?>
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="w-full mt-8 sm:p-12 p-6 overflow-hidden rounded-lg border-2 shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        <h3 class="mb-4"><?php echo e($post->title); ?>
                        ...
                        <div class="flex flex-col sm:flex-row text-xs font-semibold mt-4">
                            ...
                            <p class="sm:w-1/3 mt-2">
                                ...
                                <span class="text-right text-indigo-800">
                                    <a href="<?php echo e(route('forum.post', ['id'=>$post->id])); ?>" class="">view</a>
                                </span>
                            </p>
                        </div>
                    </div>
            ...
            <?php else: ?>
                <p>
                    There are no posts related to the topic above at the moment.
                </p>
            <?php endif; ?>
        </div>
...
<?php $__env->startSection('js'); ?>
    <script>
        document.getElementById("forum").classList.add('link-active');
    </script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/event_topics.blade.php ENDPATH**/ ?>