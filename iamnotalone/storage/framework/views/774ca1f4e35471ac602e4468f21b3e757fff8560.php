        ...
        <div class="w-full md:w-3/6 flex flex-col px-4 md:px-12">
            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="w-full mt-8 sm:p-12 p-6 overflow-hidden rounded-lg border-2 shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
                    <a href="<?php echo e(route('forum.post', ['id'=>$post->id])); ?>"><h3 class="mb-4"><?php echo e($post->title); ?></h3></a>

                    <p class="pb-8 border-b border-gray-200 font-light text-gray-600 text-justify">
                        <?php echo e($post->body); ?>

                    </p>
                    <div class="flex flex-col sm:flex-row text-xs font-semibold mt-4">
                        <p class="sm:w-2/3">
                            Posted by 
                            <span class="text-indigo-800"><?php echo e($post->user->first_name.' '.$post->user->last_name); ?></span>
                        </p>
                        <a href="<?php echo e(route('forum.post', ['id'=>$post->id])); ?>" class="">
       ...
       <form class="text-center" method="POST" action="<?php echo e(route('forum.new')); ?>">
            ...
            <div class="py-2 mt-6 flex flex-row">
                <div class="w-1/2 pr-2 md:pr-4">
                    <button type="submit" class="border-2 mx-auto sm:float-right uppercase text-sm border-indigo-400 focus:outline-none bg-primary text-white font-medium uppercase inline-block w-5/6 sm:2/3 md:4/6 py-4 rounded-lg focus:border-gray-700 hover:bg-white hover:text-gray-800">
                        Post
                    </button>
                </div>
                <div class="w-1/2 pr-2 md:pl-4">
                    <a href="#close-modal" rel="modal:close" class="border-2 mx-auto sm:float-left uppercase text-sm border-indigo-400 focus:outline-none bg-white text-gray-800 font-medium uppercase  inline-block w-5/6 sm:2/3 md:4/6 py-4 rounded-lg focus:border-gray-700 hover:bg-indigo-400 hover:text-white">
                        Cancel
                    </a>
                </div>
            </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        document.getElementById("forum").classList.add('forum-active');
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/forum.blade.php ENDPATH**/ ?>