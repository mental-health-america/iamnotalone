                ...
                <?php if(count($episodes)): ?>
                        <?php $__currentLoopData = $episodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $episode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="bg-white my-3 text-center">
                                ...
                                <td class="py-4 my-2">
                                    <div class="relative">
                                        <a href="#" class="relative z-2 block rounded-md bg-white p-2 focus:outline-none" onclick="showHideMenu('op<?php echo e($episode->id); ?>')">
                                        ...
                                        <div class="absolute right-0 mt-2 ml-10 w-32 bg-white rounded-md shadow-xl z-20 hidden" id="op<?php echo e($episode->id); ?>">
                                            <a href="<?php echo e(route('admin.training.episode.remove', ['id'=>$episode->id])); ?>" class="block px-2 py-3 rounded text-sm capitalize text-gray-700 bg-gradient-to-r hover:from-purple-400 hover:via-pink-500 hover:to-red-500 hover: hover:text-white">
                                                Delete Episode
                                            </a>
                                        </div>
                                    </div>
