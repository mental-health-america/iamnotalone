                        ...
                        <tr class="bg-white my-3 text-center">
                            ...
                            <td class="text-center py-4 my-2">
                                ...
                                <?php elseif(!$event->approved): ?>
                                    <span class="text-white bg-yellow-300 rounded-full py-2 px-4">Pending</span>
                                <?php else: ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iamnotalone/public_html/iamnotalone/resources/views/admin/pending_events.blade.php ENDPATH**/ ?>